...
-- ----------------------------
insert into `key_value` values (1,'user_message','read',1,'消息已读');
insert into `key_value` values (2,'user_message','read',0,'消息未读');
insert into `key_value` values (3,'user_info','online',0,'不在线');
insert into `key_value` values (4,'user_info','online',1,'在线');
insert into `key_value` values (5,'study_info','valid',1,'组队信息有效');
insert into `key_value` values (6,'study_info','valid',0,'组队消息失效');
insert into `key_value` values (7,'enjoy_info','sex_specific',1,'性别限制，只限异性');
insert into `key_value` values (8,'enjoy_info','sex_specific',2,'性别限制，只限同性');
insert into `key_value` values (9,'enjoy_info','sex_specific',3,'无性别限制');
insert into `key_value` values (10,'audit_info','audit_state',0,'未审核');
insert into `key_value` values (11,'audit_info','audit_state',1,'已审核');
insert into `key_value` values (12,'audit_info','audit_result',0,'申请失败');
insert into `key_value` values (13,'audit_info','audit_result',1,'申请成功');
